                ...
                if (!endId) {
                    ...
                    if (s.contains("AutogeneratedActive.OFF")) {
                        ...
                        if (s.contains("AutogeneratedActive.ON")) {
                            ...
                            if (s.contains("AutogeneratedActive.OBJECTID")) {
                                idData.setAutogeneratedActive(AutogeneratedActive.OBJECTID);
                            }else{
                                if (s.contains("AutogeneratedActive.UUID")) {
                                idData.setAutogeneratedActive(AutogeneratedActive.UUID);
                            }
                            }
                        }
                    }
