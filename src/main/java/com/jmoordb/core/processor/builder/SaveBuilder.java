...
//                    calculateReturn += repositoryData.getNameOfEntityLower() + ".set" + JmoordbCoreUtil.letterToUpper(JmoordbCoreUtil.rename_IdToId(repositoryData.getFieldPk())) + "(new ObjectId(insertOneResult.getInsertedId().asObjectId().toString()));\n";
