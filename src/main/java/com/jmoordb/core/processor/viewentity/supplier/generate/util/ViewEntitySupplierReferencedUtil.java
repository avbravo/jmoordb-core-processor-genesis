 ...
 * @author avbravo
 */
public interface ViewEntitySupplierReferencedUtil {
     ...
     * @return
     */
    public static String referencedProcess(ViewEntityData viewEntityData,
    ...
    public static String toUpdate(ViewEntityData viewEntityData, ViewEntityField viewEntityField, Element element, String caracterComa, Boolean typeReferencedEmbedded) {
         ...
         * Para listas
         */
//        String sourceSupplier = "\t\tUpdates.set(\"" + fieldLower + ".$[]\"," + fieldLower + "Supplier.toDocument(" + viewEntityNameLower + ".get" + fieldUpper + "())" + ")"+ caracterComa+"\n";
 String sourceSupplier = "";
        if (typeReferencedEmbedded) {
            
             sourceSupplier = "\t\tUpdates.set(\"" + fieldLower + "\"," + fieldLower + "Supplier.toDocument(" + viewEntityNameLower + ".get" + fieldUpper + "())" + ")" + caracterComa + "\n";
        }else{
            

             sourceSupplier = "\t\tUpdates.set(\"" + fieldLower + "\"," + fieldLower + "Supplier.toReferenced(" + viewEntityNameLower + ".get" + fieldUpper + "())" + ")" + caracterComa + "\n";
        }
        ...
        try {
             ...
             */
              if (typeReferencedEmbedded) {
            sourceSupplier = "\t\tUpdates.set(\"" + fieldLower + "\"," + fieldLower + "Supplier.toUpdate(" + viewEntityNameLower + ".get" + fieldUpper + "())" + ")" + caracterComa + "\n";
              }else{
