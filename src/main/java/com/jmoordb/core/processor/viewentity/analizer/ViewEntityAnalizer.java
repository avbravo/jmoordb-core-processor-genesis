 ...
 */
            ...
            */
            ...
            if (id != null) {
                ...
                if (!type.startsWith("java.lang.String") && !type.startsWith("java.lang.Long") && !type.startsWith("org.bson.types.ObjectId")) {
                    messager.printMessage(Diagnostic.Kind.ERROR, "Field: " + nameOfField + " Must be of type String or Long or ObjectId.", element);
                }
