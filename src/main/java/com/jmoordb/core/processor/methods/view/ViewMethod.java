...
public class ViewMethod {
    ...
    public ViewMethod(AnnotationType annotationType, ReturnType returnType, String returnTypeValue, String nameOfMethod, CaseSensitive caseSensitive, List<ParamTypeElement> paramTypeElement,
            TypeOrder typeOrder,
    ...
    private List<String> excludeTimeFields = new ArrayList<>();
        ...
        public ViewMethod build() {
            return new ViewMethod(annotationType, returnType, returnTypeValue, nameOfMethod, caseSensitive, paramTypeElement, typeOrder, havePagination, haveSorted, nameOfParametersPagination, nameOfParametersSorted, whereDescomposed,lexemas,worldAndToken
