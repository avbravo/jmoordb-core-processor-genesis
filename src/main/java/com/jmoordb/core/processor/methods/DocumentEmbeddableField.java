 ...
 * @author avbravo
 */
public class DocumentEmbeddableField {
    ...
    public DocumentEmbeddableField() {
    }

    public DocumentEmbeddableField(String returnTypeValue, String nameOfMethod, AnnotationType annotationType, ReturnType returnType, Id id, Column column, Embedded embedded, Referenced referenced, ViewReferenced viewReferenced, TypeReferenced typeReferenced) {
    ...
    public String toString() {
        ...
        sb.append("DocumentEmbeddableField{");
