...
public class CountLikeByAnalizer {
// <editor-fold defaultstate="collapsed" desc="fields()">
    ...
    public static void setMessage(String message) {
        CountLikeByAnalizer.message = message;
    }
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="Boolean analizer(LikeBy likeByAnnotation, Element element, ExecutableElement executableElement, TypeMirror typeEntity, RepositoryMethod repositoryMethod)">
    ...
    public static Boolean analizer(CountLikeBy countLikeByAnnotation, Element element, ExecutableElement executableElement, TypeMirror typeEntity, RepositoryMethod repositoryMethod) {
        try {
...
//Almacena el where
            if (!nameOfMethod.startsWith("countLikeBy")) {
                message = nameOfMethod + "() should start with countLikeBy";
                return Boolean.FALSE;
            }
             ...
             */
            if (nameOfMethod.startsWith("countLikeBy")) {
                text = text.replace("countLikeBy", "").trim();
