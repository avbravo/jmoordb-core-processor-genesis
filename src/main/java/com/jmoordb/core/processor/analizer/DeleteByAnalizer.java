...
// <editor-fold defaultstate="collapsed" desc="fields()">
    ...
    public static void setMessage(String message) {
        DeleteByAnalizer.message = message;
    }
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="analizer(ExecutableElement executableElement,TypeMirror typeEntity,RepositoryMethod repositoryMethod)">
    ...
    public static Boolean analizer(DeleteBy deleteByAnnotation, Element element, ExecutableElement executableElement, TypeMirror typeEntity, RepositoryMethod repositoryMethod) {
        try {
...
//Almacena el where
            if (!nameOfMethod.startsWith("deleteBy")) {
                message = nameOfMethod + "() should start with deleteBy";
                return Boolean.FALSE;
            }
             ...
             */
            if (nameOfMethod.startsWith("deleteBy")) {
                text = text.replace("deleteBy", "").trim();
