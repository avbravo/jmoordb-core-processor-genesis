...
// <editor-fold defaultstate="collapsed" desc="fields()">
    ...
    public static void setMessage(String message) {
        LikeByAnalizer.message = message;
    }
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="Boolean analizer(LikeBy likeByAnnotation, Element element, ExecutableElement executableElement, TypeMirror typeEntity, RepositoryMethod repositoryMethod)">
    ...
    public static Boolean analizer(LikeBy likeByAnnotation, Element element, ExecutableElement executableElement, TypeMirror typeEntity, RepositoryMethod repositoryMethod) {
        try {
...
//Almacena el where
            if (!nameOfMethod.startsWith("likeBy")) {
                message = nameOfMethod + "() should start with likeBy";
                return Boolean.FALSE;
            }
