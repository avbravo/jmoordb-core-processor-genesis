...
// <editor-fold defaultstate="collapsed" desc="RepositoryData get(Supplier<? extends RepositoryData> s, Element element)">
    ...
    public RepositoryData get(Supplier<? extends RepositoryData> s, Element element) {
        ...
        try {
            ...
            System.out.println("\t\t{test}nameOfEntity" + ProcessorUtil.nameOfEntity(typeEntity));
            System.out.println("\t\t{test}fieldPK" + idData.getFieldName());
            System.out.println("\t\t{test}idData.toString()" + idData.toString());
            ...
            System.out.println("\t\t{test}repositoryData.toString() " + repositoryData.toString());
            System.out.println("\t\t{test}{-------------------------------------------------------------------}");
        } catch (Exception e) {
