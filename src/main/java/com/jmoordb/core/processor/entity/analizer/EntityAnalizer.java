 ...
 */
            ...
            */
            ...
            if (id != null) {
                ...
                if(id.autogeneratedActive().equals(AutogeneratedActive.OBJECTID) &&  !type.startsWith("org.bson.types.ObjectId")){
                ...
                if(id.autogeneratedActive().equals(AutogeneratedActive.OFF) &&  type.startsWith("org.bson.types.ObjectId")){
                    messager.printMessage(Diagnostic.Kind.ERROR, "Field: " + nameOfField + " @Id for ObjectId is allowed only with OBJECTID..", element);
                }
                  if(id.autogeneratedActive().equals(AutogeneratedActive.UUID) &&  !type.startsWith("java.util.UUID")){
                    messager.printMessage(Diagnostic.Kind.ERROR, "Field: " + nameOfField + " UUID is only allowed for java.util.UUID data types..", element);
                }
                     if (id.autogeneratedActive().equals(AutogeneratedActive.OFF) && (!type.startsWith("java.lang.Long") && !type.startsWith("java.lang.String") )) {
                    messager.printMessage(Diagnostic.Kind.ERROR, "Field: " + nameOfField + " Autoincrementable OFF is only allowed for Long or String data types..", element);
                }
